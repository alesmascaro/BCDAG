...
```{r fig.width = 7}
par(mfrow = c(1,3))
graph::plot(as_graphNEL(DAG), main = "True DAG")
graph::plot(as_graphNEL(MPMdag), main = "MPM DAG")
graph::plot(as_graphNEL(MAPdag), main = "MAP DAG")
```
...
par(mfrow = c(1,2))
graph::plot(as_graphNEL(DAG), main = "True DAG")
graph::plot(as_graphNEL(DAG2), main = "Modified DAG")
```
