...
```{r fig.width = 7}
par(mfrow = c(1,3))
gRbase::plot(as_graphNEL(DAG), main = "True DAG")
gRbase::plot(as_graphNEL(MPMdag),, main = "MPM DAG")
gRbase::plot(as_graphNEL(MAPdag), main = "MAP DAG")
```
...
par(mfrow = c(1,2))
gRbase::plot(as_graphNEL(DAG), main = "True DAG")
gRbase::plot(as_graphNEL(DAG2), main = "Modified DAG")
```
